...
func NewPostgresCollector(logger embedlog.Logger, dsn string) (*PostgresCollector, error) {
	...
	return &PostgresCollector{
		...
		connectionsByApp:  prometheus.NewDesc("topsrv_pg_connections_by_app", "PostgreSQL connections by application name and state.", []string{"application_name", "state"}, nil),
		...
		queryTime:         prometheus.NewDesc("topsrv_pg_query_time_seconds_total", "Total query execution time.", []string{"queryid", "query", "database"}, nil),
		queryCalls:        prometheus.NewDesc("topsrv_pg_query_calls_total", "Total query calls.", []string{"queryid", "query", "database"}, nil),
		queryRows:         prometheus.NewDesc("topsrv_pg_query_rows_total", "Total rows returned by query.", []string{"queryid", "query", "database"}, nil),
		queryBlksHit:      prometheus.NewDesc("topsrv_pg_query_blks_hit_total", "Shared blocks hit by query.", []string{"queryid", "query", "database"}, nil),
		queryBlksRead:     prometheus.NewDesc("topsrv_pg_query_blks_read_total", "Shared blocks read by query.", []string{"queryid", "query", "database"}, nil),
		queryBlksDirtied:  prometheus.NewDesc("topsrv_pg_query_blks_dirtied_total", "Shared blocks dirtied by query.", []string{"queryid", "query", "database"}, nil),
		queryBlkReadTime:  prometheus.NewDesc("topsrv_pg_query_blk_read_time_seconds_total", "Block read time by query.", []string{"queryid", "query", "database"}, nil),
		queryBlkWriteTime: prometheus.NewDesc("topsrv_pg_query_blk_write_time_seconds_total", "Block write time by query.", []string{"queryid", "query", "database"}, nil),
		queryTempRead:     prometheus.NewDesc("topsrv_pg_query_temp_blks_read_total", "Temp blocks read by query.", []string{"queryid", "query", "database"}, nil),
		queryTempWritten:  prometheus.NewDesc("topsrv_pg_query_temp_blks_written_total", "Temp blocks written by query.", []string{"queryid", "query", "database"}, nil),
		queryWalBytes:     prometheus.NewDesc("topsrv_pg_query_wal_bytes_total", "WAL bytes generated by query.", []string{"queryid", "query", "database"}, nil),
		...
		txAge:             prometheus.NewDesc("topsrv_pg_longest_transaction_seconds", "Age of longest running transactions.", []string{"database", "usename"}, nil),
...
func (c *PostgresCollector) collectConnections(ctx context.Context, ch chan<- prometheus.Metric) {
	...
	// connections by application_name + state
...
func (c *PostgresCollector) collectTxAge(ctx context.Context, ch chan<- prometheus.Metric) {
